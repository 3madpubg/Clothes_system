...
│   │   ├── coreui.css          # Editable local CoreUI CSS
│   │   ├── coreui-chartjs.css  # Editable local chart CSS
│   │   ├── style.css           # Application layout and theme overrides
│   │   ├── component-styles.css # Shared component style classes
│   │   ├── examples.css        # Documentation example styles
│   │   └── vendors/            # Editable third-party style overrides
│   │
...
**CSS entry imports** (`src/App.jsx`):
```javascript
import './css/coreui.css'
import './css/coreui-chartjs.css'
...
**Application Stylesheet** (`src/css/style.css`):
```css
body {
...
**Custom Overrides** (`src/css/component-styles.css`):
```css
.my-custom-class {
...
**Usage in Components**:
```javascript
<div className="my-primary-panel">Content</div>
```
